...
class InsertPedidoMobile {
    ...
    async create(empresa, orcamento) {
        return new Promise(async (resolve, reject) => {
            ...
            let insertItensPedido = new insertItensPedidoMobile_1.InsertItensPedidoMobile();
            let codigo_pedido;
            let { codigo, forma_pagamento, descontos, observacoes, observacoes2, quantidade_parcelas, total_geral, total_produtos, total_servicos, situacao, tipo, vendedor, data_cadastro, data_recadastro, veiculo, tipo_os, contato, just_ipi, just_icms, just_subst, enviado, id } = orcamento;
            enviado = 'S';
...
exports.InsertPedidoMobile = InsertPedidoMobile;
