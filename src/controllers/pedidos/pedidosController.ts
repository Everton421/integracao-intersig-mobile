...
import { SelectPedidoIntegracao } from "../../models_integracao/pedidos/select";
...
console.log(" Atualizando pedidos ...")
   ...
   let dataHoraAtual = objDate.obterDataHoraAtual();
                ...
                for(let i of orcamentos_registrados){
                    ...
                    //console.log('')
                        let validPedidoSistema:any = await selectPedidoSistema.buscaOrcamentosCompleto(i.codigo );
                                ...
                                if(validPedidoSistema.length > 0 ){
     ...
     async buscaSincronizados(){
            const selectPedidoIntegracao = new SelectPedidoIntegracao();

            let result = await selectPedidoIntegracao.buscaSincronizados();
